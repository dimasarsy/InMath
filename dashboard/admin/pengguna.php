            ...
            <div class="container">
                ...
                <div class="row">
                    <table>
                        <tr>
                            <td>
                                <h1 style="color: #2C3E50; text-align: center;">EDIT PENGGUNA</h1><br><br><br><br>
                                <a href="data-guru.php"><button class="btn" style="width: 100%; color: black; background:#FFAC78;"><h5>Data Guru</h5></button></a><br><br>
                                <a href="data-siswa.php"><button class="btn" style="width: 100%; color: black; background:#FFAC78;"><h5>Data Siswa</h5></button></a>
                            </td>
                        </tr>
                    </table>
                </div>
