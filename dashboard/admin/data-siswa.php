    ...
    <body id="page-top">
        ...
        <section class="page-section" id="contact" style="margin-top: 100px;">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">DATA SISWA</h2><br>
                ...
                <div class="row justify-content-center">
                    ...
                    <?php
                        include('../koneksi.php');
                        $sql = "SELECT * FROM user WHERE status=0 AND level='user'";
                ...
                <div id="content" style="margin-top:100px">
                    <h5 style="text-align: center;">Daftar Siswa</h5><br>
                    <table style="width: 100%;" class="table table-striped">
                        <tr>
                            <th>
                                Nomor
                    ...
                    <?php
                        include('../koneksi.php');
                        $sql = "SELECT * FROM user WHERE status=1 AND level='user'";
                        $query = mysqli_query($connect, $sql);
                        while ($data = mysqli_fetch_array($query)) {
                            echo "<tr>";
                            echo "<td>".$nomor++."</td>";
