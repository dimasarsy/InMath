        ...
        <section class="page-section bg-primary text-white mb-0" id="about" style="padding-top: 200px;">
            <div class="container">
                ...
                <div class="row">
                    <?php 
                        include('../koneksi.php');
                        $r1 = "SELECT lagu1 FROM konten";
                        $qr1 = mysqli_query($connect, $r1);
                        $hqr1= mysqli_fetch_assoc($qr1);

                        $r2 = "SELECT lagu2 FROM konten";
                    ...
                    <table>
                        <tr>
                            <td>
                                <h1 style="color: #2C3E50; text-align: center;">LAGU ARITMATIKA SOSIAL</h1><br>
                                <form method="post" enctype="multipart/form-data">
                                    <audio controls>
                                          <source src="../lagu/musik.mp3" type="audio/mpeg">
                                    </audio>
                                    <br>
                                    <p style="color: #2C3E50;">Ganti Lagu (.mp3)</p>
                                        ...
                                        include('../koneksi.php');
                                          if (isset($_POST['submit'])) {
                                            ...
                                            if (move_uploaded_file($tmp_file, $path)) {
                                                $sql = "UPDATE konten SET lagu2 = '$nama' WHERE no=1";
                                ...
                                <br>
                                <form method="post" enctype="multipart/form-data">
                                <embed src="../img/lirik.png" width="100%" />
                                <p style="color: #2C3E50;">Ganti Lirik (.png)</p>
                                    <input type="file" name="file">
                                    <br>
                                    ...
                                    <?php 
                                        include('../koneksi.php');
                                          if (isset($_POST['submit2'])) {
                                            ...
                                            $path = "../lagu/".$nama;
                                            if (move_uploaded_file($tmp_file, $path)) {
                                                $sql = "UPDATE konten SET lagu1 = '$nama' WHERE no=1";
                                                $query = mysqli_query($connect, $sql);
                                            } else {
                                                echo "<h1 style='text-align: center; background: red; color:white;'>Isikan Data Dengan Benar! <br> (Termasuk Kolom File Tidak Boleh Kosong)</h1>";
                                            }
                    ...
                    <a href="konten.php" style="margin-top: 10px;"><button class="btn btn-primary" style="border-color: #2C3E50; margin-top:8px; background: #2C3E50"><< Kembali</button></a>
                </div>
