            ...
            <div class="container">
                ...
                <div class="row">
                    <table>
                        <tr>
                            <td>
                                <h1 style="color: #2C3E50; text-align: center;">PILIHAN BAHAN AJAR</h1><br>
                                <a href="video1.php"><button class="btn" style="width: 100%;  color: black; background: #FFAC78;"><h5>Video Pembelajaran</h5></button>></button></a>
                                <a href="rangkuman3.php"><button class="btn" style="width: 100%;  color: black; background: #FFAC78;"><h5>Rangkuman</h5></button>></button></a>
                                <a href="lagu.php"><button class="btn" style="width: 100%;  color: black; background: #FFAC78;"><h5>Lagu</h5></button>></button></a>
                            </td>
                        </tr>
                    </table>
                </div>
