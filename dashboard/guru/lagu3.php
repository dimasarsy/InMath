        ...
        <section class="page-section bg-primary text-white mb-0" id="about" style="padding-top: 200px;">
            <div class="container">
                ...
                <div class="col-md-4">
                    ...
                    <a href="lagu3.php"><button class="btn" style="width: 100%; color: black; background: #32BEA6;"><h5>Lagu Bruto, Netto, dan Tara</h5></button>></button></a>

                </div>
                <div class="col-md-8">

                    <audio controls>
                        <source src="../lagu/lagu3.mp3" type="audio/mpeg">
                    </audio>

                    <embed src="img/lagu3.png" width="100%" />
                </div>
