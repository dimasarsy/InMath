    ...
    <body id="page-top" style="background: #B1F8E5;">
        ...
        <section class="page-section bg-primary text-white mb-0" id="about" style="padding-top: 200px;">
            <div class="container">
                ...
                <h1 style="color: black; text-align: center;">Video Diskon</h1><br>
                <div class="row">
                    <div class="col-md-8">
                    <video width="100%" height="500" controls style="border-radius: 10px;">
                        <source src="../video/video 3 fix.mp4" type="video/mp4">
                    </video> 
                    </div>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <a href="video4.php" style="float: right;"><button class="btn btn-primary" style="border-color: #2C3E50; background: #2C3E50">Selanjutnya</button></a>    
                            </td>
                        </tr>
                    </table>
                </div>
