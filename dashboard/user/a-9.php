                    ...
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <!-- <form id="contactForm" data-sb-form-api-token="API_TOKEN" method="GET"> -->
                            ...
                            <div style="color: black; border-style:solid; border:1px; padding:10px; border-radius: 10px; background-color: white;">
                                <p><b>9.</b> Dalam situasi belajar dari rumah ini membuat Belinda membutuhkan laptop untuk mempermudah belajarnya. Ibunya membelikan sebuah laptop baru seharga Rp7.500.000. Beberapa minggu setelah pemakaian ternyata ada kerusakan pada baterai laptop sehingga Ibunya menjual laptop tersebut tetapi malah mengalami kerugian 2%. Maka  nominal kerugian Ibu adalah...</p>
                                <input type="radio" name="pilgan" value="A. Rp1.500.000">
                                <label>A. Rp1.500.000</label><br>
                                <input type="radio" name="pilgan" value="B. Rp1.400.000">
                                <label>B. Rp1.400.000</label><br>
                                <input type="radio" name="pilgan" value="C. Rp150.000">
                                <label>C. Rp150.000</label><br>
                                <input type="radio" name="pilgan" value="D. Rp140.000">
                                <label>D. Rp140.000</label><br>
                                ...
                                <?php 
                                    if(isset($_POST['hSkor'])) {
                                        ...
                                        $jawab = $_POST['pilgan'];
                                        $nama = $username;
                                        $correct = "UPDATE nilai SET sembilan=1 WHERE username='$nama'";
                                        $incorrect = "UPDATE nilai SET sembilan=0 WHERE username='$nama'";
                                        if ($jawab=="C. Rp150.000") {
                                            echo "<script>";
                                            echo "swal('Jawaban Anda Benar!', 'Pembahasan : Harga beli = Rp7.500.000. Persentase rugi = 2%. Rugi = Persentase rugi x Harga beli. Rugi = 2% x Rp7.500.000. Rugi =2/100×Rp7.500.000. Rugi = Rp150.000', 'success')";
                                            echo ".then((value) => {";
                                            echo "window.location.href = 'a-10.php';";
                                            echo "});";
                                            echo "</script>";
                                            $query = mysqli_query($connect, $correct);
                                        } else {
                                            echo "<script>";
                                            echo "swal('Jawaban Anda Salah!', 'Pembahasan : Harga beli = Rp7.500.000. Persentase rugi = 2%. Rugi = Persentase rugi x Harga beli. Rugi = 2% x Rp7.500.000. Rugi =2/100×Rp7.500.000. Rugi = Rp150.000', 'error')";
                                            echo ".then((value) => {";
                                            echo "window.location.href = 'a-10.php';";
                                            echo "});";
                                            echo "</script>";
