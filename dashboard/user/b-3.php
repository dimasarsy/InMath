                    ...
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <!-- <form id="contactForm" data-sb-form-api-token="API_TOKEN" method="GET"> -->
                            ...
                            <div style="color: black; border-style:solid; border:1px; padding:10px; border-radius: 10px; background-color: white;">
                                <p><b>2.</b> Harga sebuah gelang kaki setelah mendapatkan diskon 20% adalah Rp80.000. Harga beli gelang kaki tersebut sebelum diskon adalah...</p>
                                <input type="radio" name="pilgan" value="A. Rp16.000">
                                <label>A. Rp16.000</label><br>
                                <input type="radio" name="pilgan" value="B. Rp40.000">
                                <label>B. Rp40.000</label><br>
                                <input type="radio" name="pilgan" value="C. Rp64.000">
                                <label>C. Rp64.000</label><br>
                                <input type="radio" name="pilgan" value="D. Rp100.000">
                                <label>D. Rp100.000</label><br>
                                ...
                                <?php 
                                    if(isset($_POST['hSkor'])) {
                                        ...
                                        $jawab = $_POST['pilgan'];
                                        $nama = $username;
                                        $correct = "UPDATE nilai2 SET dua=1 WHERE username='$nama'";
                                        $incorrect = "UPDATE nilai2 SET dua=0 WHERE username='$nama'";
                                        if ($jawab=="D. Rp100.000") {
                                            echo "<script>";
                                            echo "swal('Jawaban Anda Benar!', 'Pembahasan : Persentase diskon = 20%. Harga setelah diskon = Rp80.000. Harga setelah diskon = (100% - Persentase diskon 20%) x Harga sebelum diskon. Rp80.000 = (100% - 20%) x Harga sebelum diskon. Rp80.000 = 80% x Harga sebelum diskon. Rp80.000 : 80% = Harga sebelum diskon. Harga sebelum diskon =Rp80.000/(80/100). Harga sebelum diskon =Rp80.000/80×100. Harga sebelum diskon =Rp800.000/8. Harga sebelum diskon = Rp100.000', 'success')";
                                            echo ".then((value) => {";
                                            echo "window.location.href = 'b-4.php';";
                                            echo "});";
                                            echo "</script>";
                                            $query = mysqli_query($connect, $correct);
                                        } else {
                                            echo "<script>";
                                            echo "swal('Jawaban Anda Salah!', 'Pembahasan : Persentase diskon = 20%. Harga setelah diskon = Rp80.000. Harga setelah diskon = (100% - Persentase diskon 20%) x Harga sebelum diskon. Rp80.000 = (100% - 20%) x Harga sebelum diskon. Rp80.000 = 80% x Harga sebelum diskon. Rp80.000 : 80% = Harga sebelum diskon. Harga sebelum diskon =Rp80.000/(80/100). Harga sebelum diskon =Rp80.000/80×100. Harga sebelum diskon =Rp800.000/8. Harga sebelum diskon = Rp100.000', 'error')";
                                            echo ".then((value) => {";
                                            echo "window.location.href = 'b-4.php';";
                                            echo "});";
                                            echo "</script>";
