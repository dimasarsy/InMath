                    ...
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <!-- <form id="contactForm" data-sb-form-api-token="API_TOKEN" method="GET"> -->
                            ...
                            <div style="color: black; border-style:solid; border:1px; padding:10px; border-radius: 10px; background-color: white;">
                                <p><b>5.</b> Suatu makanan siap saji yang dikemas seberat 4 kg memiliki netto 85%. Tara kemasan tersebut adalah...</p>
                                <input type="radio" name="pilgan" value="A. 0,6 kg">
                                <label>A. 0,6 kg</label><br>
                                <input type="radio" name="pilgan" value="B. 1,4 kg">
                                <label>B. 1,4 kg</label><br>
                                <input type="radio" name="pilgan" value="C. 2,6 kg">
                                <label>C. 2,6 kg</label><br>
                                <input type="radio" name="pilgan" value="D. 3,4 kg">
                                <label>D. 3,4 kg</label><br>
                                ...
                                <?php 
                                    if(isset($_POST['hSkor'])) {
                                        ...
                                        $jawab = $_POST['pilgan'];
                                        $nama = $username;
                                        $correct = "UPDATE nilai3 SET lima=1 WHERE username='$nama'";
                                        $incorrect = "UPDATE nilai3 SET lima=0 WHERE username='$nama'";
                                        if ($jawab=="A. 0,6 kg") {
                                            echo "<script>";
                                            echo "swal('Jawaban Anda Benar!', 'Pembahasan : Bruto = 4 kg. Persentase netto = 85%. Persentase tara = Persentase bruto – Persentase netto. Persentase tara = 100% - 85%. Persentase tara = 15%. Tara = Persentase tara x Bruto. Tara = 15% x 4 kg. Tara =3/20×4 kg. Tara =12/20 kg. Tara = 0,6 kg.', 'success')";
                                            echo ".then((value) => {";
                                            ...
                                            echo "<script>";
                                            echo "swal('Jawaban Anda Salah!', 'Pembahasan : Bruto = 4 kg. Persentase netto = 85%. Persentase tara = Persentase bruto – Persentase netto. Persentase tara = 100% - 85%. Persentase tara = 15%. Tara = Persentase tara x Bruto. Tara = 15% x 4 kg. Tara =3/20×4 kg. Tara =12/20 kg. Tara = 0,6 kg.', 'error')";
                                            echo ".then((value) => {";
                                            echo "window.location.href = 'soal.php';";
                                            echo "});";
                                            echo "</script>";
