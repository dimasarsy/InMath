                    ...
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <!-- <form id="contactForm" data-sb-form-api-token="API_TOKEN" method="GET"> -->
                            ...
                            <div style="color: black; border-style:solid; border:1px; padding:10px; border-radius: 10px; background-color: white;">
                                <p><b>6.</b> Sebuah rumah di kawasan Tebet seharga Rp800.000.000 dikenakan pajak bumi dan bangunan untuk setiap tahunnya. Jika besar pajak yang harus dibayarkan setiap tahun adalah Rp8.000.000, maka berapa persentase pajaknya?</p>
                                <input type="radio" name="pilgan" value="A. 5%">
                                <label>A. 5%</label><br>
                                <input type="radio" name="pilgan" value="B. 10%">
                                <label>B. 10%</label><br>
                                <input type="radio" name="pilgan" value="C. 15%">
                                <label>C. 15%</label><br>
                                <input type="radio" name="pilgan" value="D. 20%">
                                <label>D. 20%</label><br>
                                ...
                                <?php 
                                    if(isset($_POST['hSkor'])) {
                                        ...
                                        $jawab = $_POST['pilgan'];
                                        $nama = $username;
                                        $correct = "UPDATE nilai2 SET enam=1 WHERE username='$nama'";
                                        $incorrect = "UPDATE nilai2 SET enam=0 WHERE username='$nama'";
                                        if ($jawab=="B. 10%") {
                                            echo "<script>";
                                            echo "swal('Jawaban Anda Benar!', 'Pembahasan : Diketahui harga rumah sebelum pajak adalah Rp800.000 dengan besar pajak sebesar Rp8.000.000. Maka kita dapat mencari persentase pajak dengan rumus Persentase pajak = Besar pajak : Harga sebelum pajak x 100% Persentase pajak = Rp8.000.000 : Rp80.000.000 x 100% Persentase pajak = 10%', 'success')";
                                            echo ".then((value) => {";
                                            echo "window.location.href = 'b-8.php';";
                                            echo "});";
                                            echo "</script>";
                                            $query = mysqli_query($connect, $correct);
                                        } else {
                                            echo "<script>";
                                            echo "swal('Jawaban Anda Salah!', 'Pembahasan : Diketahui harga rumah sebelum pajak adalah Rp800.000 dengan besar pajak sebesar Rp8.000.000. Maka kita dapat mencari persentase pajak dengan rumus Persentase pajak = Besar pajak : Harga sebelum pajak x 100% Persentase pajak = Rp8.000.000 : Rp80.000.000 x 100% Persentase pajak = 10%', 'error')";
                                            echo ".then((value) => {";
                                            echo "window.location.href = 'b-8.php';";
                                            echo "});";
                                            echo "</script>";
