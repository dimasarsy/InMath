            ...
            <div class="container">
                ...
                <div class="row">
                    <table>
                        <tr>
                            <td>
                                <h1 style="color: #2C3E50; text-align: center;">PILIHAN RANGKUMAN</h1><br>
                                ...
                                <a href="rangkuman2.php"><button class="btn" style="width: 100%; color: black; background: #FFAC78;"><h5>Rangkuman Diskon</h5></button>></button></a>
