                    ...
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <!-- <form id="contactForm" data-sb-form-api-token="API_TOKEN" method="GET"> -->
                            ...
                            <div style="color: black; border-style:solid; border:1px; padding:10px; border-radius: 10px; background-color: white;">
                                <p><b>3.</b> Pak Bagas membeli 2 buah kopi yang memiliki netto sama yaitu 200 gram. Sedangkan bruto untuk mandheling coffee adalah 210 gram dan bruto untuk aming coffee adalah 205 gram. Maka masing-masing tara untuk mandheling coffee dan aming coffee adalah...</p>
                                <table>
                                    <tr>
                                        <td>
                                            <img src="../img/soal21a.jpg" style="width:100%;"></img>
                                        </td>
                                        <td>
                                            <img src="../img/soal21b.jpg" style="width:100%;"></img>
                                        </td>
                                    </tr>
                                </table>
                                <input type="radio" name="pilgan" value="A. 200 g dan 200 kg">
                                <label>A. 200 g dan 200 kg</label><br>
                                <input type="radio" name="pilgan" value="B. 5 g dan 10 g">
                                <label>B. 5 g dan 10 g</label><br>
                                <input type="radio" name="pilgan" value="C. 10 g dan 5 g">
                                <label>C. 10 g dan 5 g</label><br>
                                <input type="radio" name="pilgan" value="D. 210 g dan 205 g">
                                <label>D. 210 g dan 205 g</label><br>
                                ...
                                <?php 
                                    if(isset($_POST['hSkor'])) {
                                        ...
                                        $jawab = $_POST['pilgan'];
                                        $nama = $username;
                                        $correct = "UPDATE nilai3 SET tiga=1 WHERE username='$nama'";
                                        $incorrect = "UPDATE nilai3 SET tiga=0 WHERE username='$nama'";
                                        if ($jawab=="C. 10 g dan 5 g") {
                                            echo "<script>";
                                            echo "swal('Jawaban Anda Benar!', 'Pembahasan : Mandheling coffee. Netto = 200 gram. Bruto = 210 gram. Tara = Bruto - Netto. Tara = 210 gram - 200 gram. Bruto = 10 gram. Aming coffee. Netto = 200 gram. Bruto = 205 gram. Tara = Bruto - Netto. Tara = 205 gram - 200 gram. Bruto = 5 gram. Maka tara masing-masing madheling coffee dan aming coffee adalah 10 g dan 5 g.', 'success')";
                                            echo ".then((value) => {";
                                            echo "window.location.href = 'c-4.php';";
                                            echo "});";
                                            echo "</script>";
                                            $query = mysqli_query($connect, $correct);
                                        } else {
                                            echo "<script>";
                                            echo "swal('Jawaban Anda Salah!', 'Pembahasan : Mandheling coffee. Netto = 200 gram. Bruto = 210 gram. Tara = Bruto - Netto. Tara = 210 gram - 200 gram. Bruto = 10 gram. Aming coffee. Netto = 200 gram. Bruto = 205 gram. Tara = Bruto - Netto. Tara = 205 gram - 200 gram. Bruto = 5 gram. Maka tara masing-masing madheling coffee dan aming coffee adalah 10 g dan 5 g.', 'error')";
                                            echo ".then((value) => {";
                                            echo "window.location.href = 'c-4.php';";
                                            echo "});";
                                            echo "</script>";
