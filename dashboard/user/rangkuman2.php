    ...
    <body id="page-top" style="background: #B1F8E5;">
        ...
        <section class="page-section bg-primary text-white mb-0" id="about" style="padding-top: 200px;">
            <div class="container">
                ...
                <h1 style="color: #2C3E50; text-align: center;">Rangkuman Diskon, Pajak, dan Bunga</h1><br>
                <div class="row">
                    <div class="col-md-8">
                        <img src="../img/diskon.png" alt="" style="width: 100%; border-radius:20px;" class="mb-3">
                    </div>
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <a href="rangkuman1.php" style="float: right;"><button class="btn btn-primary" style="border-color: #2C3E50; background: #2C3E50">Selanjutnya</button></a>    
                            </td>
                        </tr>
                    </table>
                </div>
