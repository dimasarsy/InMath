        ...
        <section class="page-section bg-primary mb-0" id="about" style="padding-top: 200px;">
            <div class="container">
                ...
                <div class="row">
                    ...
                    Beberapa kilogram jeruk dimasukan kedalam peti kayu dengan berat total jeruk dan peti kayu adalah 20 kg.
                        Persentase berat jeruknya saja adalah 85%.
                        Maka berat peti kayu adalah... <br><br>
                        ...
                        Persentase netto = <input id="isi2" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width: 100px;" id="dua"> <br><br>

                        Persentase tara = Persentase bruto - Persentase netto <br>
                        Persentase tara = <input id="isi3" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width: 100px;" id="tiga"> - <input id="isi4" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width: 100px;" id="empat"> <br>
                        Persentase tara = <input id="isi5" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width: 100px;" id="lima"> <br><br>

                        Maka rumus tara adalah <br>
                        Tara = Persentase tara x Bruto <br>
                        Tara = <input id="isi6" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width: 100px;" id="enam"> x <input id="isi7" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width: 100px;" id="tujuh"> <br>
                        Tara = <input id="isi8" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width: 100px;" id="delapan"> <br>
                    </p>
                    </div>
                    <div class="col-md-4">
                    ...
                    <table>
                        <tr>
                            <td>
                                <a href="latihan-3b.php"><button class="btn btn-primary" style="border-color: #2C3E50; background: #2C3E50">Kembali</button></a> 
                            </td>
                            <td>
                            ...
                            <td>
                                <a href="index.php" style="float: right;"><button class="btn btn-primary" style="border-color: #2C3E50; background: #2C3E50">Menu</button></a>    
                            </td>
                        </tr>
                    </table>
                </div>
                <script>
                    function myFunction(){
                        ...
                        document.getElementById("dua").value = "85%";
                        document.getElementById("tiga").value = "100%";
                        document.getElementById("empat").value = "85%";
                        document.getElementById("lima").value = "15%";
                        document.getElementById("enam").value = "15%";
                        document.getElementById("tujuh").value = "20";
                        document.getElementById("delapan").value = "3";
                    }
                </script>
