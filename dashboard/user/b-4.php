                    ...
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <!-- <form id="contactForm" data-sb-form-api-token="API_TOKEN" method="GET"> -->
                            ...
                            <div style="color: black; border-style:solid; border:1px; padding:10px; border-radius: 10px; background-color: white;">
                                <p><b>3.</b> Sebuah novel dijual dengan harga Rp60.000 dan mendapat diskon Rp15.000. Persentase untung novel tersebut adalah...</p>
                                <input type="radio" name="pilgan" value="A. 15%">
                                <label>A. 15%</label><br>
                                ...
                                <?php 
                                    if(isset($_POST['hSkor'])) {
                                        ...
                                        $jawab = $_POST['pilgan'];
                                        $nama = $username;
                                        $correct = "UPDATE nilai2 SET tiga=1 WHERE username='$nama'";
                                        $incorrect = "UPDATE nilai2 SET tiga=0 WHERE username='$nama'";
                                        if ($jawab=="B. 25%") {
                                            echo "<script>";
                                            echo "swal('Jawaban Anda Benar!', 'Pembahasan : Novel dijual dengan harga Rp60.000. Maka pembeli harus membayar Rp60.000 untuk membeli novel. Sehingga Rp60.000 disebut sebagai harga beli. Diskon = Rp15.000. Persentase untung = Diskon/(Harga beli)×100%. Persentase untung =Rp15.000/Rp60.000×100%. Persentase untung =1/4×100%. Persentase untung = 25%.', 'success')";
                                            echo ".then((value) => {";
                                            echo "window.location.href = 'b-5.php';";
                                            echo "});";
                                            echo "</script>";
                                            $query = mysqli_query($connect, $correct);
                                        } else {
                                            echo "<script>";
                                            echo "swal('Jawaban Anda Salah!', 'Pembahasan : Novel dijual dengan harga Rp60.000. Maka pembeli harus membayar Rp60.000 untuk membeli novel. Sehingga Rp60.000 disebut sebagai harga beli. Diskon = Rp15.000. Persentase untung =Diskon/(Harga beli)×100%. Persentase untung =Rp15.000/Rp60.000×100%. Persentase untung =1/4×100%. Persentase untung = 25%.', 'error')";
                                            echo ".then((value) => {";
                                            echo "window.location.href = 'b-5.php';";
                                            echo "});";
                                            echo "</script>";
