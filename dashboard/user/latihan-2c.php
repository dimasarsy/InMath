        ...
        <section class="page-section bg-primary mb-0" id="about" style="padding-top: 200px;">
            <div class="container">
                ...
                <div class="row">
                    ...
                    Harga sebuah dompet setelah mendapatkan diskon 20% adalah Rp80.000. <br>
                    Harga beli dompet tersebut sebelum diskon adalah... <br><br>
                    Persentase diskon = <input id="isi" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width:100px;" id="satu"><br>
                    Harga setelah diskon = <input id="isi2" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width:100px;" id="dua"><br><br>

                    Harga setelah diskon = (100% - Persentase diskon) x Harga sebelum diskon <br>
                    <input id="isi3" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width:100px;" id="tiga"> = (100% - <input id="isi4" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width:100px;" id="empat"> ) x Harga sebelum diskon <br>
                    <input id="isi5" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width:100px;" id="lima"> = <input id="isi6" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width:100px;" id="enam"> x Harga sebelum diskon <br>
                    Harga sebelum diskon = <input id="isi7" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width:100px;" id="tujuh"> : <input id="isi8" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width:100px;" id="delapan"><br>
                    Harga sebelum diskon = <input id="isi9" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width:100px;" id="sembilan">
                    </p>
                    </div>
                    <div class="col-md-4">
                    ...
                    <table>
                        <tr>
                            <td>
                                <a href="latihan-2b.php"><button class="btn btn-primary" style="border-color: #2C3E50; background: #2C3E50">Kembali</button></a> 
                            </td>
                            <td>
                            ...
                            <td>
                                <a href="latihan-2d.php" style="float: right;"><button class="btn btn-primary" style="border-color: #2C3E50; background: #2C3E50">Selanjutnya</button></a>    
                            </td>
                        </tr>
                    </table>
                    <script>
                        ...
                        if (x == "") {
                            ...
                            document.getElementById("satu").value = "20%";
                            document.getElementById("dua").value = "80.000";
                            document.getElementById("tiga").value = "80.000";
                            document.getElementById("empat").value = "20%";
                            document.getElementById("lima").value = "80.000";
                            document.getElementById("enam").value = "80%";
                            document.getElementById("tujuh").value = "80.000";
                            document.getElementById("delapan").value = "80%";
                            document.getElementById("sembilan").value = "100.000";
                        }
                    </script>
                </div>
