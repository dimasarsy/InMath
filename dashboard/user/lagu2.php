        ...
        <section class="page-section bg-primary text-white mb-0" id="about" style="padding-top: 200px;">
            <div class="container">
                ...
                <div class="col-md-4">
                    ...
                    <a href="lagu.php"><button class="btn" style="width: 100%; color: black; background: #FFAC78;"><h5>Lagu Harga Beli, Harga Jual, Untung dan Rugi</h5></button>></button></a>
                    <a href="lagu2.php"><button class="btn" style="width: 100%; color: black; background: #32BEA6;"><h5>Lagu Diskon, Pajak, dan Bunga</h5></button>></button></a>
                ...
                <div class="col-md-8">
                    ...
                    <audio controls>
                        <source src="../lagu/lagu2.mp3" type="audio/mpeg">
                    </audio>

                    <embed src="img/lagu2.png" width="100%" />
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <a href="lagu3.php" style="float: right;"><button class="btn btn-primary" style="border-color: #2C3E50; background: #2C3E50">Selanjutnya</button></a>    
                        </td>
                    </tr>
                </table>
        </section>
