        ...
        <section class="page-section bg-primary mb-0" id="about" style="padding-top: 200px;">
            <div class="container">
                ...
                <div class="row">
                    ...
                    Bu Suci membeli 5 kardus mie instan dengan berat masing-masing adalah 3 kg.
                    Jika setelah dihitung berat mienya saja adalah 13 kg.
                    Berdasarkan informasi tersebut nilai dari keseluruhan bruto dan tara mie instan berturut-turut adalah... <br><br>

                    Berat 1 kardus mie instan = <input id="isi" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width:100px;" id="satu"> kg <br>
                    Berat 5 kardus mie instan = <input id="isi2" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width:100px;" id="dua"> x <input id="isi3" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width:100px;" id="tiga"> kg <br>
                    Bruto keseluruhan = <input id="isi4" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width:100px;" id="empat"> kg <br>

                    Berat mienya saja = <input id="isi5" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width:100px;" id="lima"> kg <br>
                    Netto keseluruhan = <input id="isi6" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width:100px;" id="enam"> kg <br><br>

                    Maka rumus tara adalah <br>
                    Tara keseluruhan - Bruto keseluruhan <br>
                    Tara keseluruhan = <input id="isi7" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width:100px;" id="tujuh"> kg - <input id="isi8" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width:100px;" id="delapan"> kg <br>
                    Tara keseluruhan = <input id="isi9" type="text" placeholder="Jawab" style="width: 100px;"><input type="text" disabled placeholder="Kunci" style="background: chartreuse; width:100px;" id="sembilan"> kg <br>
                    </p>
                    </div>
                    <div class="col-md-4">
                    ...
                    <table>
                        <tr>
                            <td>
                                <a href="latihan-3.php"><button class="btn btn-primary" style="border-color: #2C3E50; background: #2C3E50">Kembali</button></a> 
                            </td>
                            <td>
                            ...
                            <td>
                                <a href="latihan-3c.php" style="float: right;"><button class="btn btn-primary" style="border-color: #2C3E50; background: #2C3E50">Selanjutnya</button></a>    
                            </td>
                        </tr>
                    </table>
                    <script>
                        ...
                        if (x == "") {
                            ...
                            document.getElementById("satu").value = "3";
                            document.getElementById("dua").value = "5";
                            document.getElementById("tiga").value = "3";
                            document.getElementById("empat").value = "15";
                            document.getElementById("lima").value = "13";
                            document.getElementById("enam").value = "13";
                            document.getElementById("tujuh").value = "15";
                            document.getElementById("delapan").value = "13";
                            document.getElementById("sembilan").value = "2";
                        }
                    </script>
                </div>
