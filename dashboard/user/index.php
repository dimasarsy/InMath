...
<html lang="en">
    ...
    <body id="page-top" style="background: #B1F8E5;">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
            <img src="../../dashboard/img/home.png" alt="" height="70" width="70" style="margin: 1px 15px 5px 1px;"><a class="navbar-brand" href="#">Selamat Datang <br> <?php echo "$username";?></a>
                    ...
                    <div style="color: black; border-style:solid; border:1px; padding:10px; border-radius: 10px; background:white;">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                <a href="rangkuman3.php"><img class="card-img-top p-3" src="../img/grangkuman.png" alt="Card image cap" /></a>
                                <div class="card-body">
                                ...
                                <div class="col">
                                <a href="soal.php"><img class="card-img-top p-3" src="../img/gsoal.png" alt="Card image cap" /></a>
                                <div class="card-body">
