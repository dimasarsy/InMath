                    ...
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <!-- <form id="contactForm" data-sb-form-api-token="API_TOKEN" method="GET"> -->
                            ...
                            <div style="color: black; border-style:solid; border:1px; padding:10px; border-radius: 10px; background-color: white;">
                                <p><b>5.</b> Dinda dan teman-temannya pergi ke sebuah restoran untuk merayakan hari ulang tahun Dinda. Selesai pesta, Dinda berjalan ke kasir dan membayar total tagihannya. Tertera dinota bahwa total pesanananya adalah Rp869.000, kemudian Dinda juga harus membayar pajak sebesar 10%. Berapa total uang yang harus dibayarkan oleh Dinda?</p>
                                <input type="radio" name="pilgan" value="A. Rp955.900">
                                <label>A. Rp955.900</label><br>
                                <input type="radio" name="pilgan" value="B. Rp86.900">
                                <label>B. Rp86.900</label><br>
                                <input type="radio" name="pilgan" value="C. Rp782.100">
                                <label>C. Rp782.100</label><br>
                                <input type="radio" name="pilgan" value="D. Rp89.600">
                                <label>D. Rp89.600</label><br>
                                ...
                                <?php 
                                    if(isset($_POST['hSkor'])) {
                                        ...
                                        $jawab = $_POST['pilgan'];
                                        $nama = $username;
                                        $correct = "UPDATE nilai2 SET lima=1 WHERE username='$nama'";
                                        $incorrect = "UPDATE nilai2 SET lima=0 WHERE username='$nama'";
                                        if ($jawab=="A. Rp955.900") {
                                            echo "<script>";
                                            echo "swal('Jawaban Anda Benar!', 'Pembahasan : Total biaya sebelum pajak adalah Rp869.000 dengan pajak sebesar 10%. Maka besar pajak yang harus dibayar adalah Besar pajak = Persentase pajak x Total biaya sebelum pajak Besar pajak = 10% x Rp869.000 Besar pajak = Rp86.900 Sehingga total uang yang harus dibayarkan oleh Dinda adalah Total biaya setelah pajak = Total harga sebelum pajak + Besar pajak Total biaya setelah pajak = Rp869.000 + Rp86.900 Total biaya setelah pajak = Rp955.900', 'success')";
                                            echo ".then((value) => {";
                                            echo "window.location.href = 'b-7.php';";
                                            echo "});";
                                            echo "</script>";
                                            $query = mysqli_query($connect, $correct);
                                        } else {
                                            echo "<script>";
                                            echo "swal('Jawaban Anda Salah!', 'Pembahasan : Total biaya sebelum pajak adalah Rp869.000 dengan pajak sebesar 10%. Maka besar pajak yang harus dibayar adalah Besar pajak = Persentase pajak x Total biaya sebelum pajak Besar pajak = 10% x Rp869.000 Besar pajak = Rp86.900 Sehingga total uang yang harus dibayarkan oleh Dinda adalah Total biaya setelah pajak = Total harga sebelum pajak + Besar pajak Total biaya setelah pajak = Rp869.000 + Rp86.900 Total biaya setelah pajak = Rp955.900', 'error')";
                                            echo ".then((value) => {";
                                            echo "window.location.href = 'b-7.php';";
                                            echo "});";
                                            echo "</script>";
