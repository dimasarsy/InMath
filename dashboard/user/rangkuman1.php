    ...
    <body id="page-top" style="background: #B1F8E5;">
            ...
            <a href="index.php"><img src="../../dashboard/img/home.png" alt="" height="70" width="70" style="margin: 1px 15px 5px 1px;"></a><a class="navbar-brand" href="#">Selamat Datang <br> <?php echo "$username";?></a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="video1.php">Video</a></li>
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded" href="rangkuman3.php" style="color: #1ABC9C;">Rangkuman</a></li>
        ...
        <section class="page-section bg-primary text-white mb-0" id="about" style="padding-top: 200px;">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <img src="../img/bruto.png" alt="" style="width: 100%; border-radius:20px;" class="mb-3">
                    </div>
                        ...
                        <tr>
                            <td>
                                ...
                                <!-- <video width="100%" height="500" controls style="border-radius: 10px;">
                                    <source src="../video/video 1 fix.mp4" type="video/mp4">
                                </video>  -->
                                <!-- <embed src="../rangkuman/1.pdf" width="100%" height="550px" /> -->
                    ...
                    <table>
                        <tr>
                            <td>
                                <a href="rangkuman.php"><button class="btn btn-primary" style="border-color: #2C3E50; background: #2C3E50">Menu</button></a>    
                            </td>
                            <td>
