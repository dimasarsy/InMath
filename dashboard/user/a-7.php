                    ...
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <!-- <form id="contactForm" data-sb-form-api-token="API_TOKEN" method="GET"> -->
                            ...
                            <div style="color: black; border-style:solid; border:1px; padding:10px; border-radius: 10px; background-color: white;">
                                <p><b>7.</b> Kakak membeli sebuah sepeda motor baru seharga Rp18.000.000. Jika Kakak menjual motor tersebut dan mendapatkan rugi 5%. Maka besar nominal kerugiannya adalah...</p>
                                <input type="radio" name="pilgan" value="A. Rp360.000">
                                <label>A. Rp360.000</label><br>
                                <input type="radio" name="pilgan" value="B. Rp760.000">
                                <label>B. Rp760.000</label><br>
                                <input type="radio" name="pilgan" value="C. Rp800.000">
                                <label>C. Rp800.000</label><br>
                                <input type="radio" name="pilgan" value="D. Rp900.000">
                                <label>D. Rp900.000</label><br>
                                ...
                                <?php 
                                    if(isset($_POST['hSkor'])) {
                                        ...
                                        $jawab = $_POST['pilgan'];
                                        $nama = $username;
                                        $correct = "UPDATE nilai SET tujuh=1 WHERE username='$nama'";
                                        $incorrect = "UPDATE nilai SET tujuh=0 WHERE username='$nama'";
                                        if ($jawab=="D. Rp900.000") {
                                            echo "<script>";
                                            echo "swal('Jawaban Anda Benar!', 'Pembahasan : Harga beli = Rp18.000.000. Persentase rugi = 5%. Rugi = Persentase rugi x Harga beli. Rugi = 5% x Rp18.000.000. Rugi =5/100×Rp18.000.000. Rugi = Rp900.000.', 'success')";
                                            echo ".then((value) => {";
                                            echo "window.location.href = 'a-8.php';";
                                            echo "});";
                                            echo "</script>";
                                            $query = mysqli_query($connect, $correct);
                                        } else {
                                            echo "<script>";
                                            echo "swal('Jawaban Anda Salah!', 'Pembahasan : Harga beli = Rp18.000.000. Persentase rugi = 5%. Rugi = Persentase rugi x Harga beli. Rugi = 5% x Rp18.000.000. Rugi =5/100×Rp18.000.000. Rugi = Rp900.000.', 'error')";
                                            echo ".then((value) => {";
                                            echo "window.location.href = 'a-8.php';";
                                            echo "});";
                                            echo "</script>";
