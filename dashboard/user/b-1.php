                    ...
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <!-- <form id="contactForm" data-sb-form-api-token="API_TOKEN" method="GET"> -->
                            ...
                            <div style="color: black; border-style:solid; border:1px; padding:10px; border-radius: 10px; background-color: white;">
                                <p><b>1.</b> Pak Sahid membeli sebuah meja belajar dengan harga Rp450.000. Jika Pak Sahid menjualnya dan ingin mendapatkan untung Rp120.000, sekaligus memberi diskon Rp20.000 pada pembeli, maka harga jual meja belajar tersebut seharusnya...</p>
                                <input type="radio" name="pilgan" value="A. Rp600.000">
                                <label>A. Rp600.000</label><br>
                                <input type="radio" name="pilgan" value="B. Rp590.000">
                                <label>B. Rp590.000</label><br>
                                <input type="radio" name="pilgan" value="C. Rp580.000">
                                <label>C. Rp580.000</label><br>
                                <input type="radio" name="pilgan" value="D. Rp570.000">
                                <label>D. Rp570.000</label><br>
                                ...
                                <?php 
                                    if(isset($_POST['hSkor'])) {
                                        ...
                                        $jawab = $_POST['pilgan'];
                                        $nama = $username;
                                        $correct = "INSERT INTO nilai2 SET username='$nama', satu=1";
                                        $incorrect = "INSERT INTO nilai2 SET username='$nama', satu=0";
                                        if ($jawab=="B. Rp590.000") {
                                            echo "<script>";
                                            echo "swal('Jawaban Anda Benar!', 'Pembahasan : Harga beli = Rp450.000. Untung = Rp120.000. Diskon = Rp20.000. Harga jual = Harga beli + Untung + Diskon. Harga jual = Rp450.000 + Rp120.000 + Rp20.000. Harga jual = Rp590.000.', 'success')";
                                            echo ".then((value) => {";
                                            echo "window.location.href = 'b-3.php';";
                                            echo "});";
                                            echo "</script>";
                                            $query = mysqli_query($connect, $correct);
                                        } else {
                                            echo "<script>";
                                            echo "swal('Jawaban Anda Salah!', 'Pembahasan : Harga beli = Rp450.000. Untung = Rp120.000. Diskon = Rp20.000. Harga jual = Harga beli + Untung + Diskon. Harga jual = Rp450.000 + Rp120.000 + Rp20.000. Harga jual = Rp590.000.', 'error')";
                                            echo ".then((value) => {";
                                            echo "window.location.href = 'b-3.php';";
                                            echo "});";
                                            echo "</script>";
