                    ...
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <!-- <form id="contactForm" data-sb-form-api-token="API_TOKEN" method="GET"> -->
                            ...
                            <div style="color: black; border-style:solid; border:1px; padding:10px; border-radius: 10px; background-color: white;">
                                <p><b>4.</b> Toko AF menjual pulpen unik yang dapat dihapus dengan penghapus pensil. Dini pernah memakai pulpen tersebut di sekolah dan teman-temannya meminta untuk dibelikan pulpen tersebut. Dini memutuskan untuk membeli 15 pulpen untuk dijual kembali ke teman-temannya dengan harga keseluruhan Rp300.000.  Kemudian dijual dengan harga Rp21.000/pulpen. Pendapatan total yang diperoleh Dini tersebut adalah...</p>
                                <input type="radio" name="pilgan" value="A. Rp325.000">
                                <label>A. Rp325.000</label><br>
                                <input type="radio" name="pilgan" value="B. Rp315.000">
                                <label>B. Rp315.000</label><br>
                                <input type="radio" name="pilgan" value="C. Rp355.000">
                                <label>C. Rp355.000</label><br>
                                <input type="radio" name="pilgan" value="D. Rp335.000">
                                <label>D. Rp335.000</label><br>
                                ...
                                <?php 
                                    if(isset($_POST['hSkor'])) {
                                        ...
                                        $jawab = $_POST['pilgan'];
                                        $nama = $username;
                                        $correct = "UPDATE nilai SET empat=1 WHERE username='$nama'";
                                        $incorrect = "UPDATE nilai SET empat=0 WHERE username='$nama'";
                                        if ($jawab=="B. Rp315.000") {
                                            echo "<script>";
                                            echo "swal('Jawaban Anda Benar!', 'Pembahasan : Pendapatan adalah besar pemasukan yang dilakukan akibat suatu usaha. Maka pendapatan disini adalah hasil penjualan 15 pulpen dengan harga jual Rp21.000/pulpen. Pendapatan = 15 x Rp21.000. Pendapatan = Rp315.000.', 'success')";
                                            echo ".then((value) => {";
                                            echo "window.location.href = 'a-5.php';";
                                            echo "});";
                                            echo "</script>";
                                            $query = mysqli_query($connect, $correct);
                                        } else {
                                            echo "<script>";
                                            echo "swal('Jawaban Anda Salah!', 'Pembahasan : Pendapatan adalah besar pemasukan yang dilakukan akibat suatu usaha. Maka pendapatan disini adalah hasil penjualan 15 pulpen dengan harga jual Rp21.000/pulpen. Pendapatan = 15 x Rp21.000. Pendapatan = Rp315.000.', 'error')";
                                            echo ".then((value) => {";
                                            echo "window.location.href = 'a-5.php';";
                                            echo "});";
                                            echo "</script>";
